...
| Entry       |                     |                                   |
|-------------+---------------------+-----------------------------------|
| ~et~        | set status          | org-agenda-todo                   |
| ~ek~        | kill                | org-agenda-kill                   |
| ~er~        | refile              | org-agenda-refile                 |
| ~eA~        | archive             | org-agenda-archive-default        |
| ~eT~        | set tags            | org-agenda-set-tags               |
| ~ep~        | set priority        | org-agenda-priority               |
|-------------+---------------------+-----------------------------------|
| Visit entry |                     |                                   |
|-------------+---------------------+-----------------------------------|
